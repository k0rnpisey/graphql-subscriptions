...
type MutationResolver interface {
	...
	AddFriend(ctx context.Context, userID string, friendID string) (*model.User, error)
}
...
func (ec *executionContext) field_Mutation_upsertUser_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNUserInput2gqlgenᚑsubscriptionsᚋgraphᚋmodelᚐUserInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Query_users(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.User)
	fc.Result = res
	return ec.marshalOUser2ᚕᚖgqlgenᚑsubscriptionsᚋgraphᚋmodelᚐUser(ctx, field.Selections, res)
}
	...
	return func(ctx context.Context) graphql.Marshaler {
		...
		case res, ok := <-resTmp.(<-chan *model.User):
			...
			return graphql.WriterFunc(func(w io.Writer) {
				...
				w.Write([]byte{':'})
				ec.marshalNUser2ᚖgqlgenᚑsubscriptionsᚋgraphᚋmodelᚐUser(ctx, field.Selections, res).MarshalGQL(w)
				w.Write([]byte{'}'})
			})
		case <-ctx.Done():
			return nil
	...
	return func(ctx context.Context) graphql.Marshaler {
		...
		case res, ok := <-resTmp.(<-chan *model.Time):
			...
			return graphql.WriterFunc(func(w io.Writer) {
				...
				graphql.MarshalString(field.Alias).MarshalGQL(w)
				w.Write([]byte{':'})
				ec.marshalNTime2ᚖgqlgenᚑsubscriptionsᚋgraphᚋmodelᚐTime(ctx, field.Selections, res).MarshalGQL(w)
				w.Write([]byte{'}'})
			})
		case <-ctx.Done():
			return nil
...
func (ec *executionContext) unmarshalInputUserInput(ctx context.Context, obj interface{}) (model.UserInput, error) {
	...
	fieldsInOrder := [...]string{"id", "name", "friends"}
	for _, k := range fieldsInOrder {
		...
		case "friends":
			...
			data, err := ec.unmarshalOUserInput2ᚕᚖgqlgenᚑsubscriptionsᚋgraphᚋmodelᚐUserInput(ctx, v)
			if err != nil {
				return it, err
			}
			it.Friends = data
...
func (ec *executionContext) marshalNTime2gqlgenᚑsubscriptionsᚋgraphᚋmodelᚐTime(ctx context.Context, sel ast.SelectionSet, v model.Time) graphql.Marshaler {
	return ec._Time(ctx, sel, &v)
}

func (ec *executionContext) marshalNTime2ᚖgqlgenᚑsubscriptionsᚋgraphᚋmodelᚐTime(ctx context.Context, sel ast.SelectionSet, v *model.Time) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNUser2gqlgenᚑsubscriptionsᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v model.User) graphql.Marshaler {
...
func (ec *executionContext) unmarshalNUserInput2gqlgenᚑsubscriptionsᚋgraphᚋmodelᚐUserInput(ctx context.Context, v interface{}) (model.UserInput, error) {
...
func (ec *executionContext) marshalOUser2ᚕᚖgqlgenᚑsubscriptionsᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v []*model.User) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalOUser2ᚖgqlgenᚑsubscriptionsᚋgraphᚋmodelᚐUser(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalOUser2ᚖgqlgenᚑsubscriptionsᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v *model.User) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._User(ctx, sel, v)
...
func (ec *executionContext) unmarshalOUserInput2ᚕᚖgqlgenᚑsubscriptionsᚋgraphᚋmodelᚐUserInput(ctx context.Context, v interface{}) ([]*model.UserInput, error) {
	if v == nil {
		return nil, nil
	}
	var vSlice []interface{}
	...
	for i := range vSlice {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithIndex(i))
		res[i], err = ec.unmarshalOUserInput2ᚖgqlgenᚑsubscriptionsᚋgraphᚋmodelᚐUserInput(ctx, vSlice[i])
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) unmarshalOUserInput2ᚖgqlgenᚑsubscriptionsᚋgraphᚋmodelᚐUserInput(ctx context.Context, v interface{}) (*model.UserInput, error) {
	if v == nil {
		return nil, nil
	}
	res, err := ec.unmarshalInputUserInput(ctx, v)
